  ...
  return db
    .prepare(
      `SELECT public_id, name, country_code, photo_r2_key, current_mode,
              sex, birth_date, ${NEXT_VACCINE_EXPR} AS next_vaccine_date, color_markings, breed_mix, weight, notes,
...
export async function getCatPublicProfile(
  ...
  return db
    .prepare(
      `SELECT public_id, name, country_code, photo_r2_key, current_mode,
              sex, birth_date, ${NEXT_VACCINE_EXPR} AS next_vaccine_date, color_markings, breed_mix, weight, microchip_number
       FROM cats
