...
<style>*{box-sizing:border-box}body{font-family:system-ui,-apple-system,sans-serif;max-width:1080px;margin:1.5rem auto;padding:0 1rem;color:#111;line-height:1.5}.top{display:flex;justify-content:space-between;gap:1rem;align-items:flex-start;flex-wrap:wrap}.top>*{min-width:0}h1{overflow-wrap:anywhere}.language label{display:block;font-size:.8rem;font-weight:700;margin-bottom:.2rem}.language select,input{padding:.62rem;border:1px solid #cfcfcf;border-radius:6px;min-height:44px;font-size:1rem}.filters{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:.65rem;margin:1rem 0 1.25rem;align-items:end}.filters button{width:100%}button,.actions a{border:0;border-radius:6px;background:#111;color:#fff;padding:.65rem .9rem;text-decoration:none;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;min-height:44px;text-align:center;line-height:1.2;overflow-wrap:anywhere}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:1rem}.card{border:1px solid #ddd;border-radius:8px;padding:1rem;background:#fff;min-width:0;display:flex;flex-direction:column}.card h2{margin:.7rem 0 .35rem;font-size:1.05rem;overflow-wrap:anywhere}.card p{margin:.3rem 0;overflow-wrap:anywhere}.card img,.placeholder{width:100%;aspect-ratio:4/3;object-fit:cover;background:#eee;border-radius:7px;display:flex;align-items:center;justify-content:center;color:#666;text-align:center;padding:.5rem}.badge{display:inline-flex;align-items:center;max-width:100%;background:#f1f1f1;border-radius:999px;padding:.18rem .58rem;font-size:.85rem;overflow-wrap:anywhere}.actions{display:flex;gap:.5rem;flex-wrap:wrap;margin-top:auto;padding-top:.8rem}.actions a{font-size:.9rem;flex:1 1 140px}.empty{padding:1rem;border:1px dashed #bbb;border-radius:8px;background:#fafafa;overflow-wrap:anywhere}@media(max-width:430px){body{margin:1rem auto;padding:0 .75rem}.grid{grid-template-columns:1fr}.filters{grid-template-columns:1fr}.actions a{flex-basis:100%}}</style></head>
<body>
