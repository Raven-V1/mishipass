  ...
  <main class="page-shell">
    ...
    <section class="mp-card detail-card">
      ...
      <div class="info-grid" id="info-grid">
        ...
        <div class="info-row"><span class="info-label">${t(lang, "breedMix")}</span><span class="info-value" id="val-breed">${escapeHtml(cat.breed_mix ?? "")}</span><input class="info-edit-input hidden" id="inp-breed" list="breed-datalist" value="${escapeHtml(cat.breed_mix ?? "")}" maxlength="100" /><datalist id="breed-datalist"><option value="Mixed / Unknown / Other"></option><option value="Abyssinian"></option><option value="Bengal"></option><option value="British Shorthair"></option><option value="Devon Rex"></option><option value="Domestic Longhair"></option><option value="Domestic Shorthair"></option><option value="European Burmese"></option><option value="Maine Coon"></option><option value="Persian"></option><option value="Ragdoll"></option><option value="Russian Blue"></option><option value="Scottish Fold"></option><option value="Siamese"></option><option value="Sphynx"></option><option value="Turkish Angora"></option></datalist></div>
        <div class="info-row"><span class="info-label">${t(lang, "colorMarkings")}</span><span class="info-value" id="val-color">${escapeHtml(cat.color_markings ?? "")}</span><input class="info-edit-input hidden" id="inp-color" list="color-datalist" value="${escapeHtml(cat.color_markings ?? "")}" maxlength="200" /><datalist id="color-datalist"><option value="Black"></option><option value="White"></option><option value="Gray"></option><option value="Orange"></option><option value="Cream"></option><option value="Brown"></option><option value="Calico"></option><option value="Tortoiseshell"></option><option value="Tabby"></option><option value="Tuxedo"></option><option value="Pointed / Siamese-style"></option><option value="Mixed / Other"></option></datalist></div>
