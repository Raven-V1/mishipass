...
| 5 | Switch to Missing Alert | City, area, optional reward setting, optional Recovery Board publishing |
...
| 12 | Open Recovery Board | Only opted-in Missing alerts appear; city and alert-age filters work |
